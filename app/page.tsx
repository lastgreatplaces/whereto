...
const CAMP_THEMES: Record<string, Theme> = {
  ...
  NM: { color: "#5d4037", emoji: "🏞️" },
  NS: { color: "#5d4037", emoji: "🏞️" },
  SP: { color: "#2afc05", emoji: "⛰️" },
  SPR: { color: "#2afc05", emoji: "⛰️" },
  SF: { color: "#388e3c", emoji: "🌳" },
   SFW: { color: "#7eb6ed", emoji: "🐤" },
   USFW: { color: "#7eb6ed", emoji: "🐤" },
   NWR: { color: "#7eb6ed", emoji: "🐤" },
